...
public class DayCare {
    ...
    private static String currentDate = "12-2021"; // MM-yyyy
    ...
    public List<String> findVaccStatusByID(int id){
        ...
        for (VaccRecord vaccRecord : vaccRecords){
            if (vaccRecord.getStudentId() == id){
                ...
                }else if (requiredDose.get(0) > vaccRecord.getHib() && DateUtiles.getMonthDiff(vaccUpdateDate.get(0),currentDate) > 12 && isOverDue){
                ...
                if (requiredDose.get(1) <= vaccRecord.getDTaP()){
                    vaccStatus.add("Compliance");
                }else if (requiredDose.get(1) > vaccRecord.getDTaP() && DateUtiles.getMonthDiff(vaccUpdateDate.get(1),currentDate) > 12 && isOverDue){
                    vaccStatus.add("Overdue");
                }else {
                    vaccStatus.add("Not compliance");
                }
                ...
                if (requiredDose.get(2) <= vaccRecord.getPolio()){
                    vaccStatus.add("Compliance");
                }else if (requiredDose.get(2) > vaccRecord.getPolio() && DateUtiles.getMonthDiff(vaccUpdateDate.get(2),currentDate) > 12 && isOverDue){
                    vaccStatus.add("Overdue");
                }else {
                    vaccStatus.add("Not compliance");
                }
                ...
                if (requiredDose.get(3) <= vaccRecord.getHepatitsB()){
                    vaccStatus.add("Compliance");
                }else if (requiredDose.get(3) > vaccRecord.getHepatitsB() && DateUtiles.getMonthDiff(vaccUpdateDate.get(3),currentDate) > 12 && isOverDue){
                    vaccStatus.add("Overdue");
                }else {
                    vaccStatus.add("Not compliance");
                }
                ...
                if (requiredDose.get(4) <= vaccRecord.getMMR()){
                    vaccStatus.add("Compliance");
                }else if (requiredDose.get(4) > vaccRecord.getMMR() && DateUtiles.getMonthDiff(vaccUpdateDate.get(4),currentDate) > 12 && isOverDue){
                    vaccStatus.add("Overdue");
                }else {
                    vaccStatus.add("Not compliance");
                }
                ...
                if (requiredDose.get(5) <= vaccRecord.getVaricella()){
                    vaccStatus.add("Compliance");
                }else if (requiredDose.get(5) > vaccRecord.getVaricella() && DateUtiles.getMonthDiff(vaccUpdateDate.get(5),currentDate) > 12 && isOverDue){
                    vaccStatus.add("Overdue");
                }else {
                    vaccStatus.add("Not compliance");
                }
